      ...
      <section style={{ ...styles.hero, flexDirection: isMobile ? 'column' : 'row' }}>
        <div style={{ flex: 1, minWidth: '300px' }}>
          ...
          <h1 style={styles.title}>
            ...
            <span style={styles.titleHighlight}>Operations Center (MOC)</span>
          </h1>
          <p style={styles.serviceList}>
            • OS/Server Management<br />
            • Database Management<br />
            • DC Network Management<br />
      ...
      <section style={styles.section}>
        ...
        <div style={{ ...styles.contentRow, flexDirection: isMobile ? 'column' : 'row' }}>
          ...
          <p style={styles.description}>
            ...
            applications, security, messaging, and storage & backup.<br /><br />
            We dramatically simplify WAN infrastructure monitoring and management.
            Our experts at Datagami Network Operations Center (NOC) and Security Operations Center (SOC)
            use automated tools to manage MPLS operations, network infrastructure, and security threats.
          </p>
        </div>
      </section>
